...
#define PHOTO_BYTES_PER_PIXEL         1

//Pin Definitions
const int chipSelect                 = 53; 
const int HardwareSSPin              = 53;
...
{
      Serial.println(F("Setting up OV7670 Camera ..."));
...
void setup() 
{
      ...
      Serial.println(F("Copyright 2017 by Rajiv B.  All Rights Reserved."));
      Serial.println();
      Serial.println(F("Please refer the code for detailed explanations"));
...
void SetupOV7670ForQVGAYUV()
{
      ...
      Serial.print(F("Photo Width = "));
      Serial.println(PHOTO_WIDTH/2);
      Serial.print(F("Photo Height = "));
      Serial.println(PHOTO_HEIGHT/2); 
      Serial.print(F("Bytes Per Pixel = "));
      Serial.println((PHOTO_BYTES_PER_PIXEL * 2));
      // Basic Registers
...
void SetupOV7670ForQQVGAYUV()
{
      ...
      Serial.print(F("Photo Width = "));
      Serial.println(PHOTO_WIDTH/4);
      Serial.print(F("Photo Height = "));
      Serial.println(PHOTO_HEIGHT/4);
      Serial.print(F("Bytes Per Pixel = "));
      Serial.println((PHOTO_BYTES_PER_PIXEL*2));
